...
public class TestProductCatalogue {
    ...
    final static String EMBEDDED_TEST_PU = "shop_test_embedded_pu";
    ...
    public void testGetRange() {
        ...
        for( int i = 0; i < 10 ; i++){
            pc.add(new Product(String.valueOf(i), i, Product.Category.ACTION));
        }
    ...
    public void testAddUpdateAndRemoveProduct() {
        ...
        Product p1 = new Product("banana", 11.11, Product.Category.RPG);
        int count = pc.getCount();
        
        pc.add(p1);
        assertTrue(pc.getCount() == count + 1);
        ...
        Product p = new Product(p1.getId(), "updated", p1.getPrice(), p1.getCategory());
        p1 = pc.update(p);
        /*
    ...
    public void testGetByName() {
        IProductCatalogue pc = shop.getProductCatalogue();
        Product p = new Product("banana", 11.11, Product.Category.RPG);
        pc.add(p);
